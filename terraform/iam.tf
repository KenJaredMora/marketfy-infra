...
# Role for GitHub Actions (CI/CD) - Optional
...
# Attach CloudWatch Logs policy for EC2 instances
resource "aws_iam_role_policy_attachment" "ecs_instance_cloudwatch" {
  role       = aws_iam_role.ecs_instance_role.name
  policy_arn = "arn:aws:iam::aws:policy/CloudWatchLogsFullAccess"
}

# Attach SSM policy for debugging (optional but useful)
resource "aws_iam_role_policy_attachment" "ecs_instance_ssm" {
  role       = aws_iam_role.ecs_instance_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

# IAM Instance Profile (this is what EC2 instances use)
resource "aws_iam_instance_profile" "ecs_instance_profile" {
  name = "ecsInstanceRole"  # Must match name in ecs.tf line 54
  role = aws_iam_role.ecs_instance_role.name
