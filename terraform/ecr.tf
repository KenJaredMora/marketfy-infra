...
# ECR Repository for React Frontend
...
# Lifecycle Policy for Angular Repository
resource "aws_ecr_lifecycle_policy" "angular" {
  repository = aws_ecr_repository.angular.name
...
# Lifecycle Policy for React Repository
...
resource "aws_ecr_repository_policy" "angular" {
  repository = aws_ecr_repository.angular.name
